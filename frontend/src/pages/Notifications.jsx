            ...
            <div className="container">
				...
				<nav className="navbar navbar-expand-lg header-nav">
					...
					<div className="main-menu-wrapper">
						...
						<ul className="main-nav">
							<li className="has-submenu megamenu">
								<Link to="/notifications">Home <i  className="material-icons-outlined">expand_more</i></Link>
						...
						<div className="menu-account">
							...
							<div className="d-flex align-items-center gap-2">
								...
								<Link to="/notifications" className="avatar avatar-sm">
						...
						<div className="menu-dropdown">
                            <div className="dropdown mb-2">
								<Link to="/notifications" className="dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown">
					...
					<div className="nav header-items">
						...
						<Link to="/notifications" className="topbar-link btn btn-light topbar-search" data-bs-toggle="modal" data-bs-target="#search-modal">
							<i className="material-icons-outlined">search</i>
						</Link>

						<div className="dropdown topbar-lang">
							<Link to="/notifications" className="topbar-link btn btn-light" data-bs-toggle="dropdown">
								...
								<div className="notification-head">
									<div className="row align-items-center">
										...
										<div className="col-auto">
											<div className="dropdown">
												<Link to="/notifications" className="text-body" data-bs-toggle="dropdown" data-bs-offset="0,15" aria-expanded="false">
						...
						<div className="dropdown topbar-profile d-flex">
							<Link to="/notifications" className="avatar" data-bs-toggle="dropdown">
								<img src="/assets/img/users/user-06.jpg" alt="img" className="img-fluid rounded-circle" />
							</Link>
							<div className="dropdown-menu dropdown-menu-end">
