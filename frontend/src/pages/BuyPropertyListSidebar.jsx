            ...
            <div className="container">
				...
				<nav className="navbar navbar-expand-lg header-nav">
					...
					<div className="main-menu-wrapper">
						...
						<ul className="main-nav">
							<li className="has-submenu megamenu">
								<Link to="/buy-property-list-sidebar">Home <i  className="material-icons-outlined">expand_more</i></Link>
								...
								<ul className="submenu">
									<li className="has-submenu active">
										...
										<ul className="submenu ">
											...
											<li className="active"><Link to="/buy-property-list-sidebar">Buy List with Sidebar</Link></li>
						...
						<div className="menu-account">
							...
							<div className="d-flex align-items-center gap-2">
								...
								<Link to="/buy-property-list-sidebar" className="avatar avatar-sm">
						...
						<div className="menu-dropdown">
                            <div className="dropdown mb-2">
								<Link to="/buy-property-list-sidebar" className="dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown">
					...
					<div className="nav header-items">
						...
						<Link to="/buy-property-list-sidebar" className="topbar-link btn btn-light topbar-search" data-bs-toggle="modal" data-bs-target="#search-modal">
							<i className="material-icons-outlined">search</i>
						</Link>

						<div className="dropdown topbar-lang">
							<Link to="/buy-property-list-sidebar" className="topbar-link btn btn-light" data-bs-toggle="dropdown">
								...
								<div className="notification-head">
									<div className="row align-items-center">
										...
										<div className="col-auto">
											<div className="dropdown">
												<Link to="/buy-property-list-sidebar" className="text-body" data-bs-toggle="dropdown" data-bs-offset="0,15" aria-expanded="false">
						...
						<div className="dropdown topbar-profile d-flex">
							<Link to="/buy-property-list-sidebar" className="avatar" data-bs-toggle="dropdown">
								<img src="/assets/img/users/user-06.jpg" alt="img" className="img-fluid rounded-circle" />
							</Link>
							<div className="dropdown-menu dropdown-menu-end">
