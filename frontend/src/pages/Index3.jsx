			...
			<footer className="footer-three footer-dark">
									...
									<div className="col-md-4 col-sm-6">
										<div className="contact-info">
											...
											<div>
												...
												<h6><a href="https://dreamsestate.dreamstechnologies.com/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="dab3b4bcb59abfa2bbb7aab6bff4b9b5b7">[email&#160;protected]</a></h6>
											</div>
										</div>
									</div> 
				...
				<div className="footer-bottom">
					<div className="text-center">
						<p className="copy-right">Copyright &copy; <script data-cfasync="false" src="../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script type="436cce7a91c853ad63dfc8d1-text/javascript">document.write(new Date().getFullYear())</script>. All Rights Reserved, Dreams Estate</p>
					</div>
				</div>
