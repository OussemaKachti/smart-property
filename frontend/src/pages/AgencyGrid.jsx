		...
		<div className="container">
			...
			<nav className="navbar navbar-expand-lg header-nav">
				...
				<div className="main-menu-wrapper">
					...
					<ul className="main-nav">
						<li className="has-submenu megamenu">
							<Link to="/agency-grid">Home <i  className="material-icons-outlined">expand_more</i></Link>
						...
						<li className="has-submenu active">
							...
							<ul className="submenu">
								<li className="active"><Link to="/agency-grid">Agency Grid</Link></li>
					...
					<div className="menu-account">
						...
						<div className="d-flex align-items-center gap-2">
							...
							<Link to="/agency-grid" className="avatar avatar-sm">
					...
					<div className="menu-dropdown">
						<div className="dropdown mb-2">
							<Link to="/agency-grid" className="dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown">
				...
				<div className="nav header-items">
					...
					<Link to="/agency-grid" className="topbar-link btn btn-light topbar-search" data-bs-toggle="modal" data-bs-target="#search-modal">
						<i className="material-icons-outlined">search</i>
					</Link>

					<div className="dropdown topbar-lang">
						<Link to="/agency-grid" className="topbar-link btn btn-light" data-bs-toggle="dropdown">
							...
							<div className="notification-head">
								<div className="row align-items-center">
									...
									<div className="col-auto">
										<div className="dropdown">
											<Link to="/agency-grid" className="text-body" data-bs-toggle="dropdown" data-bs-offset="0,15" aria-expanded="false">
					...
					<div className="dropdown topbar-profile d-flex">
						<Link to="/agency-grid" className="avatar" data-bs-toggle="dropdown">
							<img src="/assets/img/users/user-06.jpg" alt="img" className="img-fluid rounded-circle" />
						</Link>
						<div className="dropdown-menu dropdown-menu-end">
			...
			<div className="container">
				...
				<div className="row justify-content-center">
					...
					<div className="col-xl-3 col-lg-4 col-md-6">
						<div className="agent-item">
							<div className="agent-img">
								<Link to="/agency-details"><img src="/assets/img/agency/agency-07.png" className="img-fluid" alt="" /></Link>
								<div className="position-absolute top-0 end-0 p-3">
					...
					<div className="col-xl-3 col-lg-4 col-md-6">
						<div className="agent-item">
							<div className="agent-img">
								<Link to="/agency-details"><img src="/assets/img/agency/agency-08.png" className="img-fluid" alt="" /></Link>
								<div className="position-absolute top-0 end-0 p-3">
				...
				<div className="text-center pt-3">
					<Link to="/agency-grid" className="btn btn-dark align-items-center d-inline-flex"><i className="material-icons-outlined me-1">autorenew</i>Load More</Link>
				</div>
